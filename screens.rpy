...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Reset") action Function(clear_data)
...
screen babyroom_options(is_food_visible=True, is_exit_visible=False, is_exit_labelled=False, is_rat_visible=True):
    imagebutton:
        ...
        hover toys_image
        action Return('babyroom.toys')
        hovered mtt.TextAction("Toys")
        focus_mask True
        xpos 0 ypos 0
    if is_food_visible:
        imagebutton:
            idle im.Alpha(babyroom_food_image, 0.8)
            hover babyroom_food_image
            action Return('babyroom.food')
            hovered mtt.TextAction("Food")
            focus_mask True
            xpos 0 ypos 0
    imagebutton:
        idle im.Alpha(babyroom_cot, 0.8)
        hover babyroom_cot
        action Return('babyroom.cot')
...
screen attic_options(is_balcony_label_visible=False):
    imagebutton:
        ...
        action Return('attic.curtains')
        hovered mtt.TextAction("Curtains")
        focus_mask True
        xpos 0 ypos 0
    imagebutton:
        idle im.Alpha(attic_photos_image, 0.8)
        hover attic_photos_image
        action Return('attic.photos')
    ...
    imagebutton:
        idle im.Alpha(arrow_left, 0.8)
        hover arrow_left
        if is_balcony_label_visible:
            hovered mtt.TextAction("Balcony")
        else:
            hovered mtt.TextAction("Head left")
        action Return('attic.balcony')
        xpos 200 ypos 800
    imagebutton:
...
screen balcony_options():
    imagebutton:
        idle im.Alpha(balcony_plants_image, 0.8)
...
screen hallway_options(wardrobe_label_visible=False,
    ...
    imagebutton:
        ...
        action Return('hallway.wardrobe')
        if wardrobe_label_visible:
    ...
    imagebutton:
        ...
        action Return('hallway.master_bedroom')
        if master_bedroom_label_visible:
    ...
    imagebutton:
        ...
        action Return('hallway.toilet')
        if toilet_label_visible:
...
screen master_bedroom_options(is_wardrobe_label_visible=False):
    imagebutton:
        idle im.Alpha(master_bedroom_roomba_image, 0.8)
    ...
    imagebutton:
        idle im.Alpha(arrow_left, 0.8)
        hover arrow_left
        action Return('master_bedroom.hallway')
        hovered mtt.TextAction("Hallway")
        xpos 300 ypos 800
    imagebutton:
        idle im.Alpha(arrow_right, 0.8)
        hover arrow_right
        action Return('master_bedroom.wardrobe')
        if is_wardrobe_label_visible:
            hovered mtt.TextAction("Wardrobe")
        else:
            hovered mtt.TextAction("Other door")
        xpos 1400 ypos 800
    add mtt

screen wardrobe_options(is_ring_visible=True):
    imagebutton:
        idle im.Alpha(wardrobe_laundry_image, 0.8)
    ...
    imagebutton:
        idle im.Alpha(arrow_right, 0.8)
        hover arrow_right
        action Return('wardrobe.hallway')
        hovered mtt.TextAction("Hallway")
        xpos 1550 ypos 800
    add mtt

screen kitchen_options():
    imagebutton:
        idle im.Alpha(kitchen_trashcan_image, 0.8)
        hover kitchen_trashcan_image
    ...
    imagebutton:
        idle im.Alpha(arrow_left, 0.8)
        hover arrow_left
        action Return('kitchen.hallway')
        hovered mtt.TextAction("Hallway")
        xpos 0 ypos 800
    add mtt

screen dining_room_options(is_leftovers_visible=True, is_fresh_food_visible=True):
    if is_leftovers_visible:
        imagebutton:
            idle im.Alpha(dining_room_leftovers_image, 0.8)
    ...
    imagebutton:
        idle im.Alpha(arrow_right, 0.8)
        hover arrow_right
        action Return('dining_room.hallway')
        hovered mtt.TextAction("Hallway")
        xpos 1550 ypos 800
    add mtt

screen ending_options():
    imagebutton:
        idle im.Alpha(ending_door_image, 0.8)
